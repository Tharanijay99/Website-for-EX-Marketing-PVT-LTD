...
function FilterModal() {
    ...
    return (
        <div >
            <button type="button" className="button-main-banner" data-toggle="modal" onClick={handleIwant} data-target="#myModal">
                Click Here
            </button>
                ...
                <div className="modal-dialog modal-xl modal-dialog-scrollable">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h5 className="modal-title" id="exampleModalLabel">Choose according to your preference</h5>
                        ...
                        <div className="modal-body" style={{"background" : "rgb(245, 245, 245)"}}>
                            ...
                            <label htmlFor=""> <br></br>What is your favourite brand?</label>
                            ...
                            <label htmlFor=""><br></br>Price Range</label>
                            <div className="row">
                                <div className="col p-0">
                                    <div className="form-group mx-sm-3 m-6">
