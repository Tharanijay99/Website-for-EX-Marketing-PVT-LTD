          ...
          <div className="row">
            ...
            <div className="col-sm-3">
              ...
              <div className="footer-link d-flex flex-column">
                ...
                <Link className="text-white py-1 mb-1" to="/Login">Login</Link>
                <Link className="text-white py-1 mb-1" to="/Cart">Cart</Link>
              </div>
            </div>
            <div className="col-sm-3">
              <h4 className="text-white mb-2">Quick Links</h4>
              <div className="footer-link d-flex flex-column">
                <Link className="text-white py-1 mb-1"  to="/">Home</Link>
                <Link className="text-white py-1 mb-1"  to="/product">OurStore</Link>
                <Link className="text-white py-1 mb-1"  to="/blogs">Blogs</Link>
