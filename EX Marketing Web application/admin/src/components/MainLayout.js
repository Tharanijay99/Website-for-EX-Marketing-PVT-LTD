...
import { PiBooksFill, PiListPlusBold } from "react-icons/pi";
...
import logoImage from '../images/LogoEX.png';
    ...
    <Layout /* onContextMenu={(e) => e.preventDefault()} */>
      <Sider trigger={null} collapsible collapsed={collapsed}>
        ...
        <Menu
          ...
          items={[
            {
              key: "",
              icon: <AiOutlineAreaChart className="fs-4" />,
              label: "Dashboard",
            },
            {
              key: "customers",
            ...
            {
              key: "Catalog",
              icon: <PiBooksFill className="fs-4" />,
              label: "Catalog",
              children: [
                {
                  key: "product",
                  icon: <HiOutlinePlus className="fs-4" />,
                  label: "Add Product",
                },
                {
                  key: "list-product",
            ...
            {
              key: "blogs",
              icon: <CgWebsite className="fs-4" />,
              label: "Blogs",
              children: [
                {
                  key: "blog",
                  icon: <PiListPlusBold className="fs-4" />,
                  label: "Add Blog",
                },
                {
                  key: "blog-list",
      ...
      <Layout className="site-layout">
        ...
        >
          ...
          <div> 
            <img src={logoImage} alt="No image" width="220" height="30"/>
          </div>


          <div className="d-flex gap-4 align-items-center">
          <Link
                    className="signo dropdown-item py-1 mb-1"
